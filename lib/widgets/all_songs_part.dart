...
class _AllSongsPageState extends State<AllSongsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(foregroundColor: Theme.of(context).textTheme.bodySmall!.color, backgroundColor: Theme.of(context).colorScheme.background, centerTitle: true, title: Text('All Songs', style: Theme.of(context).textTheme.bodyLarge),),
